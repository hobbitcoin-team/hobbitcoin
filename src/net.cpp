...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Hobbitcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"www.hobbit.co.in", "wallet01.hobbit.co.in"},{"www.hobbit.co.in", "wallet02.hobbit.co.in"},{"www.hobbit.co.in", "wallet03.hobbit.co.in"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"www.hobbit.co.in", "testwallet01.hobbit.co.in"},{"www.hobbit.co.in", "testwallet02.hobbit.co.in"},{"www.hobbit.co.in", "testwallet03.hobbit.co.in"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Hobbitcoin is probably already running."), addrBind.ToString().c_str());
        else
